...
a pre-specified AI-Readiness index (42\% of reachable sites): it does not block AI crawlers, but
...
permission, llms.txt adoption, and schema readiness together; (2) a pre-specified operational
...
Full protocol and pre-registration: \texttt{PROTOCOL.md}, \texttt{osf\_prereg.md}; the confirmatory
wave is registered on OSF at \url{https://osf.io/2q5er/}.
...
\item \textbf{AI-Readiness index (pre-specified, 0--10):} allows AI crawlers $+2$; valid llms.txt
