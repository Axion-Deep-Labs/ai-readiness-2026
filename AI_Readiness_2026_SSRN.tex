...
Query frame, parsed dataset (CC BY 4.0), code (build/crawl/analyze), and the versioned AI-crawler and
schema codebooks are released. Raw HTML is not redistributed.
